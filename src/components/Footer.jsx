      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a
                href="https://github.com/tresforge"
              ...
              <a
                href="https://linkedin.com/company/tresforge"
                className="social-link"
                aria-label="LinkedIn"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://twitter.com/tresforge"
                className="social-link"
                aria-label="Twitter"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; {currentYear} TRESFORGE. Все права защищены.</p>
          </div>
