  ...
  const projects = [
    {
      ...
      category: "web",
      description:
        "Современная платформа электронной коммерции с интегрированной системой платежей и управления заказами.",
      image: portfolio3,
    ...
    },
    {
      ...
      category: "devops",
      description:
        "Комплексная система мониторинга инфраструктуры с real-time аналитикой и алертами.",
      image: portfolio4,
    ...
    },
    {
      ...
      category: "mobile",
      description:
        "Мобильное приложение для творческих проектов с интуитивным интерфейсом и богатым функционалом.",
      image: portfolio5,
    ...
    },
    {
      ...
      category: "web",
      description:
        "Корпоративный сайт с современным дизайном, CMS и интеграцией с внешними сервисами.",
      image: portfolio1,
    ...
    },
    {
      ...
      category: "design",
      description:
        "Персональное портфолио разработчика с анимациями и интерактивными элементами.",
      image: portfolio2,
    ...
    },
    {
      ...
      category: "devops",
      description:
        "Автоматизированная облачная инфраструктура с CI/CD пайплайнами и мониторингом.",
            ...
            >
              ...
              <div className="portfolio-content">
                <div className="portfolio-meta">
                  ...
                  <span
                    className={`portfolio-category category-${project.category}`}
                  >
